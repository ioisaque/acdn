...
<?php get_template_part( 'sub_page_header', 'sub_page_header_file' );?>
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>            
			...
			<div class="box four-five last blog single">
				...
				<div class="post_data">		
					...
					<a href="<?php comments_link(); ?>" title="<?php comments_number( __('0 comentários','rt_theme'), __('1 comentário','rt_theme'), __('% comentários','rt_theme') ); ?>" class="comment_link"><?php comments_number( __('0 comentários','rt_theme'), __('1 comentário','rt_theme'), __('% comentários','rt_theme') ); ?></a>
				</div>
		...
		<!-- Info Box -->		
			...
			<h5><?php _e( 'Sobre o Autor', 'rt_theme' ); ?></h5>
