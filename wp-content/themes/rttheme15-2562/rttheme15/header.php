...
<div id="container">
	...
	<div id="content">
		...
		<?php if( (( get_option(THEMESLUG."_slider_active") && is_front_page()) || is_front_page() || get_page_template_slug() == "home-page-template.php"  || get_page_template_slug() == "builder-template.php" || get_page_template_slug() == "builder-template-with-slider.php" ) && (!get_option(THEMESLUG.'_remove_curvs')) ) echo '<div class="slider_cover"></div>';  ?>
