...
$contact_form.= "".    
	...
	'		<ul>'.
	'			<li><label for="name">'.__('Seu Nome: (*)','rt_theme').'</label><input id="name" type="text" name="name" value="" class="required" /> </li>'.
	'			<li><label for="email">'.__('Seu E-mail: (*)','rt_theme').'</label><input id="email" type="text" name="email" value="" class="required email" /> </li>'.
	...
	'			<li><label for="message">'.__('Sua menssagem (*)','rt_theme').'</label><textarea  id="message" name="message" rows="8" cols="40"	class="required"></textarea></li>'.
	'			<li>'.
	...
	'			<input type="submit" class="button" value="'.__('Enviar','rt_theme').'"  /><span class="loading"></span></li>'.
	'		</ul>'.
	'	</form>'.
