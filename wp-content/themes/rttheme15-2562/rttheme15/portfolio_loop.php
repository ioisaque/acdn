		...
		<span class="frame block">
			...
			<?php if($media_link):?><a href="<?php echo $media_link;?>" title="<?php echo $title; ?>" rel="prettyPhoto[rt_theme_portfolio]" class="imgeffect <?php echo $button;?>"><?php endif;?>
				...
				<?php if($custom_thumb)://auto resize not active?>
				    <a href="<?php echo $permalink ?>" title="<?php $title; ?>" class="imgeffect link"><img src="<?php echo $custom_thumb;?>" alt="<?php echo $title; ?>" /></a>   
				<?php elseif($video_thumbnail):?>
				    <a href="<?php echo $permalink ?>" title="<?php $title; ?>" class="imgeffect link"><img src="<?php echo $video_thumbnail["url"];?>" alt="<?php echo $title;?>" /></a>   
				<?php else:?>
				    <a href="<?php echo $permalink ?>" title="<?php $title; ?>" class="imgeffect link"><img src="<?php echo $image_thumb["url"];?>" alt="<?php echo $title;?>" /></a>   
				<?php endif;?>
