...
class SimpleVisitorCounter_Widget extends WP_Widget {
    ...
    function form( $instance ) {
        $defaults = array(
        'textfontfamily' => 'Oswald, arial, serif',
        'textcolor'=>'#000',
        'headingfontfamily'=>'Oswald, arial, serif',
        'headingcolor'=>'#000'
        );
        ...
        ?>
            <p>
                ...
                <select class="widefat" id="<?php echo $this->get_field_id( 'headingfontfamily' ); ?>" name="<?php echo $this->get_field_name( 'headingfontfamily' ); ?>">
                    ...
                    <option <?php if($headingfontfamily == "Oswald, arial, serif"){?> selected <?php }?> value="Oswald, arial, serif">Oswald, arial, serif</option>
                </select>
            </p>
            ...
            <p>
                ...
                <select class="widefat" id="<?php echo $this->get_field_id( 'textfontfamily' ); ?>" name="<?php echo $this->get_field_name( 'textfontfamily' ); ?>">
                    ...
                    <option <?php if($textfontfamily == "Oswald, arial, serif"){?> selected <?php }?> value="Oswald, arial, serif">Oswald, arial, serif</option>
                </select>
            </p>
    ...
    function widget( $args, $instance ) {
        ...
        <aside class="widget" id="visitor-counter">
            <h2 class="visitor-counter-heading" style="font-family:<?php echo $headingfontfamily ?>; color:<?php echo $headingcolor ?>;" ><?php echo sprintf("%06d", vcp_get_visit_count('T')+14194);  ?></h2>
        <div class="visitor-counter-content" style="color: <?php echo $textcolor ?>; font-family: <?php echo $textfontfamily ?>;" >
            ...
            <p>Online agora: <?php echo vcp_get_visit_count('C') ?></p>-->
			
			<p> pessoas já visitaram este site!</p>
        </div>
        </aside>
